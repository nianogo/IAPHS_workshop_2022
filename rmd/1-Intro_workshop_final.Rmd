...
There will be three html files
- The setup (this file) (1/3)   
- Difference-in-difference (DID) and related methods (2/3)   
- Synthetic control methods and related methods (3/3)   




**Should you have any questions, need help to reproduce the analysis or find coding errors, please do not hesitate to contact us at niaroch@ucla.edu**.
...
p_load("tidyverse","magrittr","broom",        #for manipulating data
       ...
       "ggdag",                               #for drawing a Directed Acylic Diagram (DAG)
...
p
```
Note that Alaska (which is treated) is not shown on the map  
