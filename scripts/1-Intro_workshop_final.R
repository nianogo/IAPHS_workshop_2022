...
#--------------------methods for Population Health Scientists"-----------------#
...
mydata_nopt <- read_csv(here("data", "sim_data_nopt.csv"))
mydata_nocs <- read_csv(here("data", "sim_data_nocs.csv"))
